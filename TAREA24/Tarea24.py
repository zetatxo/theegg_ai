...
el numero es mayor o igual a dos. Si en este proceso el numero coge valor de tres o dos, se añaden a la lista tanto el resto como finalmente
el cociente. La lista resultado final, será la inversa de resultado, que es el resultante en binario del numero introducido. Finalmente se 
